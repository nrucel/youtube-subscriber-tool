...
<head>
    ...
    <title>Youtube Abone Hilesi - <?=$siteAdi?></title>
...
<body class="menubar-top menubar-light theme-primary" style="font-family: 'Titillium Web', sans-serif;">
    <nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top danger">
        <div class="navbar-header">
            ...
            <a href="<?=base_url("panel")?>" class="navbar-brand"style="font-size:35px;padding: 10px;"><?=$siteAdi?></a></div>
                ...
                <ul class="app-menu">
                    ...
                    <li>
                        <a href="<?=base_url("panel")?>">
                            ...
                            <span class="menu-text"><i class="fas fa-user-plus fa-lg"></i> Abone Gönder</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?=base_url("panel/referans")?>">
                            <span class="menu-text"><i class="fas fa-plus fa-lg"></i>  Kredi Kazan</span>
                        </a>
                    </li>
                    <li>
...
<div class="card card-info center">
    <div class="widget" style="padding: 10px; background: #e64343; color: white;">
                              
                    <img src="<?=$uye->ytFoto;?>" style="height: 30px;"/>  @<?=$uye->adSoyad;?>   Abone: <?=$uye->aboneSayisi;?>  | Video: <?=$uye->videoSayisi;?> | İzlenme: <?=$uye->izlenmeSayisi;?> | Krediniz: <?=$uye->aboneKredi?>
                                
            </div>
            <div class="alert alert-dismissible alert-info">
            <p>Merhaba <b><?=$uye->adSoyad;?></b>, Sistemimiz <strong>her saat</strong> kredileri yenilemektedir. Sistem şuan beta aşamasındadır. Herhangi bir sorun yada destek talebi için <strong><a href="mailto:<?=$this->config->item("varsayilanGonderenMaili")?>"><?=$this->config->item("gorunurMail")?></a></strong> adresine mail atabilirsiniz. <? if($this->config->item("yoneticiTel") !== "") { ?> İletişim numaramız: <strong><? echo $this->config->item("yoneticiTel"); } ?></strong> yada <strong><a href="https://begenapp.net/soru" target="_blank">Soru/Cevap</a> </strong> alanımızda daha hızlı çözüme ulaşabilirsiniz.</p>
            </div>
            <p>
